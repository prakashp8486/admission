...
if (isset ($_POST['submit']))
{
  ...
  //sname,  class,  gname,  contact,  gender, email,  bloodg, address,  division, shift
  $query="INSERT INTO admission(sname,class,gname,contact,gender,email,bloodg,address,division,shift)values('$sname','$class','$gname','$contact','$gender','$email','$bloodg','$address','$division','$shift')";
                            ...
                            <div class="col-md-6">
                              <div class="left-side-form">
                                ...
                                <h5><label for="sname">Student name</label>
                                  ...
                                  <p><input type="text" name="sname" value="" required></p>

                                  <h5><label for="gname">gurdian name</label><span class="error">
                                  </span></h5>
                                  <p><input type="text" name="gname" value="" required></p>

                                  <h5><label for="contact">contact</label><span class="error">
                                  </span></h5>
                                  <p><input type="text" name="contact" value="" required></p>
                              ...
                              <div class="col-md-6">
                                <div class="right-side-form">
                                  ...
                                  <p><input type="text" name="class" value="" required></p>

                                  <h5><label for="shift">shift</label></h5>
                                  <p><select name="shift" required>
                                  ...
                                  <p><input type="text" name="bloodg" value="" required></p>
