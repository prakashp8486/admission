			...
			<div class="col-md-12">
				...
				<div class="row">
                    ...
                    <span class="error">* All fields are required.</span>
										...
										<h5><label for="contact">contact Number</label><span class="error">
												</span></h5>
										<p><input type="text" name="contact" value="" required></p>

										<h5><label for="email">Email id</label><span class="error">
												</span></h5>
                    ...
                    <input type="submit" name="contactSubmit" value="SUBMIT" class="text-center">
									</div>
								</div>
						</form>
					</div>
